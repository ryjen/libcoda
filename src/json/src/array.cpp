...
namespace coda {
  namespace json {
    ...
    array::array(array &&other) : value_(other.value_) { other.value_ = NULL; }
    ...
    size_t array::size() const { return json_object_array_length(value_); }
    ...
    void array::add_string(size_t i, const string &value) {
      json_object_array_put_idx(value_, i,
    ...
    object array::operator[](size_t idx) const { return get(idx); }
    ...
    object array::front() const { return get(0); }

    object array::back() const { return get(size() - 1); }

    array::iterator array::begin() const { return iterator(value_, 0); }
    ...
    array::iterator array::begin() { return iterator(value_, 0); }

    array::iterator array::end() {
      return iterator(value_, json_object_array_length(value_));
    }

    array::reverse_iterator array::rbegin() { return reverse_iterator(end()); }

    array::reverse_iterator array::rend() { return reverse_iterator(begin()); }
    ...
    bool array::is_valid() const { return value_ != NULL; }
  } // namespace json
} // namespace coda
