...
namespace coda {
  namespace json {
    ...
    object_iterator::object_iterator(const object_iterator &other)
        : entry_(other.entry_) {}
    object_iterator::object_iterator(object_iterator &&other)
        : entry_(other.entry_) {
      other.entry_ = NULL;
    }
    ...
    bool object_iterator::is_valid() const { return entry_ != NULL; }
    ...
    object_iterator::reference object_iterator::get_ref() {
      ...
      ref_ = make_pair(
          string(static_cast<char *>(entry_->k)),
          object(static_cast<json_object *>(const_cast<void *>(entry_->v))));
