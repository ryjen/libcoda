...
namespace coda {
  namespace json {
    ...
    class array_iterator : public iterator<random_access_iterator_tag, object> {
      ...
      typedef typename iterator<random_access_iterator_tag, object>::value_type
          value_type;
      typedef
          typename iterator<random_access_iterator_tag, object>::difference_type
              difference_type;
      typedef typename iterator<random_access_iterator_tag, object>::reference
          reference;
      typedef typename iterator<random_access_iterator_tag, object>::pointer
          pointer;
